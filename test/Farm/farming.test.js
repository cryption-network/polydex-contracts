...
describe("Farm", function () {
  ...
  context("With ERC/LP token added to the field", function () {
    ...
    it("should give proper CNTs allocation to each pool", async function () {
      ...
      await this.farm.add("10", this.lp.address, 0, 0, true);
      ...
      await this.farm.add("20", this.lp2.address, 0, 0, true);
      // Alice should have 10*1000 pending reward
      expect(await this.farm.pendingCNT(0, this.alice.address)).to.equal(
        "10000"
      );
      ...
      expect(await this.farm.pendingCNT(1, this.bob.address)).to.equal("3333");
    });
    ...
    it("should stop giving bonus CNTs after the bonus period ends", async function () {
      ...
      await this.lp
        .connect(this.alice)
        .approve(this.farm.address, "1000", { from: this.alice.address });
      await this.farm.add("1", this.lp.address, 0, 0, true);
      ...
      expect(await this.farm.pendingCNT(0, this.alice.address)).to.equal("0");
